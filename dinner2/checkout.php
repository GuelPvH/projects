...
$cliente_telefone = isset($_SESSION['usuario_telefone']) ? $_SESSION['usuario_telefone'] : '';
$telefone_mascarado = mascararTelefone($cliente_telefone);
...
foreach($listaPedidos as $nomeLanche => $dados) {
    if ($dados['Quantidade'] === 'Item Removido' || $dados['Quantidade'] <= 0) continue;
...
<body>
    ...
    <div class="container" style="padding-bottom: 120px;">
        ...
        <label class="radio-card">
            <input type="radio" name="modalidade" value="mesa" onchange="checkFormStatus()">
            <div>
                <div style="font-weight:600">Na mesa</div>
                <div class="small">Receber na lanchonete</div>
            </div>
        </label>
        
        <label class="radio-card">
            <input type="radio" name="modalidade" value="balcao" onchange="checkFormStatus()">
            <div>
        ...
        <div class="user-info-card">
            <div class="user-info-details">
                <p class="fw-bold"><?php echo htmlspecialchars($cliente_nome); ?></p>
                <p class="small"><?php echo htmlspecialchars($telefone_mascarado); ?></p>
            </div>
            <a href="index.php" class="edit-icon">
    ...
    <div class="sticky-footer checkout-footer">
        ...
        <button type="button" class="btn btn-primary" id="btn-finalizar" style="opacity: 0.5; pointer-events: none;" onclick="alert('Pedido realizado com sucesso!')">
            Fazer pedido
        </button>
    </div>
    ...
    <script>
        function togglePaymentMethods(type) {
            ...
            // clear specific method selection when switching category
        ...
        function checkFormStatus() {
            ...
            // Habilita se os dois estiverem selecionados
