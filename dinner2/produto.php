...
<body>
    ...
    <div class="obs-section container">
        <div class="form-group">
            ...
            <textarea id="observacoes" class="form-control" placeholder="Ex: Tirar cebola, maionese à parte..."></textarea>
    ...
    <div class="sticky-footer" style="padding: 12px 16px;">
        <div class="sticky-footer-inner" style="gap: 16px;">
            ...
            <button class="btn btn-primary sticky-footer-btn" id="add-btn" onclick="addToCart(<?php echo $produto_id; ?>)">
