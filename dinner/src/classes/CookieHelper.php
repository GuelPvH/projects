...
class CookieHelper {
    ...
    public static function registrarCookiesLogin($nome, $sobrenome) {
        // Salva por 30 dias (HttpOnly ativado)
        setcookie('app_cliente_nome', $nome, time() + 86400 * 30, '/', '', false, true);
        setcookie('app_cliente_sobrenome', $sobrenome, time() + 86400 * 30, '/', '', false, true);
    }
    ...
    public static function destruirCookies() {
        ...
        setcookie('app_cliente_sobrenome', '', time() - 3600, '/');
    }
